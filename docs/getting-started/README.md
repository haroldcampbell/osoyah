...
-   `01-overview.md` - Purpose, where to start, and the high-level flow.
-   `02-structure.md` - Folder layout and key files.
-   `03-process.md` - Spec-driven development workflow and testing.
...
-   If you add new onboarding topics, continue numbering for ordering.
